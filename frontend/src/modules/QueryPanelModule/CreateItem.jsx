...
import { selectCreatedQuery } from '@/redux/query/selectors';
...
export default function CreateItem({ config, CreateForm }) {
  ...
  const onSubmit = (fieldsValue) => {
    ...
    dispatch(query.create({ entity, jsonData: fieldsValue }));
  };
    ...
    <>
      ...
      <Loading isLoading={isLoading}>
        <Form form={form} layout="vertical" onFinish={onSubmit}>
          <CreateForm isSubmitted={isSubmitted} queryId={queryId} form={form} config={config} />
        </Form>
      </Loading>
    </>
  );
